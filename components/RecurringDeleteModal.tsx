        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div>
                <span className="block font-medium text-slate-800 dark:text-slate-200 text-sm">
                  Solo esta instancia
                </span>
                <span className="block text-xs text-slate-500">
                  Elimina solo este registro del historial.
                </span>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <span className="block font-medium text-rose-700 dark:text-rose-300 text-sm">
                  Toda la serie
                </span>
                <span className="block text-xs text-rose-600/70 dark:text-rose-400/70">
                  Elimina esta y todas las futuras.
                </span>
              </div>
            </button>
          </div>
