...
describe('Dashboard', () => {
  it('renders category names from transaction rows', () => {
    render(<Dashboard transactions={mockTransactions} categories={mockCategories} onEdit={() => {}} onDelete={() => {}} />);
  ...
  it('shows empty state for sections when no transactions', () => {
    render(<Dashboard transactions={[]} categories={mockCategories} onEdit={() => {}} onDelete={() => {}} />);
